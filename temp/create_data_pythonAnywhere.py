# pythonAnywhere에서 데이터 생성을 위한 코드로, 주피터 노트북에서 작성한 코드를 그대로 복사하여 사용하였다.
...
schedule.every(600).seconds.do(make_data)
# schedule.every().day.at('20:00').do(make_data)
